...
public class AvroSerdes {
    ...
    public static SpecificAvroSerde<TrendScore> trendScore() {
        SpecificAvroSerde<TrendScore> serde = new SpecificAvroSerde<>();
    ...
    public static SpecificAvroSerde<UserInterest> userInterest() {
        SpecificAvroSerde<UserInterest> serde = new SpecificAvroSerde<>();
        serde.configure(serdeConfig, false); // false = not key, Only for value serialization

        return serde;
    }

    public static SpecificAvroSerde<TrendAlert> trendAlertSerde() {
        SpecificAvroSerde<TrendAlert> serde = new SpecificAvroSerde<>();
        serde.configure(serdeConfig, false); // false = not key, Only for value serialization
